...
export type TaskPage = TasksPath['get']['responses'][200]['content']['application/json']
export type TaskList = TaskPage['data']
export type TaskPagination = TaskPage['pagination']

...
type RolePermissionsPath = paths['/api/v1/roles/{roleId}/permissions']
...
export type RoleWithPermissions = RolePath['get']['responses'][200]['content']['application/json']
...
export type ReplaceRolePermissions = RolePermissionsPath['put']['requestBody']['content']['application/json']
...
export type AssignedRole = UserWithRoles['roles'][number]

...
describe('authentication router guard', () => {
  ...
  it('checks the session only for protected routes', async () => {
    ...
    cache.setQueryData(AUTHORIZATION_KEY, {
      ...
      roles: [],
      rules: [
        { action: 'read', subject: 'profile', conditions: { id: '00000000-0000-0000-0000-000000000001' } },
        { action: 'read', subject: 'tasks', conditions: { userId: '00000000-0000-0000-0000-000000000001' } }
      ],

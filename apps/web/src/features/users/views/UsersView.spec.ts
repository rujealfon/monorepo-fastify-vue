...
const userRows = [
  { id: 'admin-id', email: 'admin@example.com', role: 'admin', createdAt: '2026-01-01T00:00:00Z', updatedAt: '' },
  { id: 'other-admin-id', email: 'admin2@example.com', role: 'admin', createdAt: '2026-01-01T00:00:00Z', updatedAt: '' },
  { id: 'user-id', email: 'user@example.com', role: 'user', createdAt: '2026-01-01T00:00:00Z', updatedAt: '' }
]

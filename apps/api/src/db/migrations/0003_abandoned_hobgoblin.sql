CREATE TABLE "permissions" (
	...
	CONSTRAINT "valid_permission_key" CHECK ("permissions"."key" = '*' OR "permissions"."key" ~ '^[a-z][a-z0-9_]*(\.[a-z][a-z0-9_]*)+$')
);
...
--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "authorization_version" integer DEFAULT 1 NOT NULL;--> statement-breakpoint

...
// the super_admin invariant lives here too: its permissions are always the full catalog
...
// Lockout is structurally impossible: nobody can change or delete their own account here,
// so the number of super admins can never drop to zero through these paths.

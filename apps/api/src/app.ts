...
// .certs/ dir (gitignored: it holds a private key), shared with app and site
// (apps/app/vite.config.ts, apps/site/nuxt.config.ts). Reusing that cert here
// avoids trusting a second CA just for the API. Enabling automatically once
// the cert exists (rather than an opt-in env flag) matches app/site, and keeps
...
export function buildApp(): FastifyInstance {
  ...
  // app (app.mysite.com) and site (mysite.com) are separate Vercel projects/origins
